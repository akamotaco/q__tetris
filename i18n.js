...
(function (root, factory) {
  ...
  const CATALOG = {
    ko: {
      ...
      'submit.reveal': '공유 링크에 내 이름을 표시', 'submit.nameWarn': '⚠ 링크를 여는 사람은 이 이름을 봅니다 — 재공유되면 그 사람에게도 보여요. 공개 보드에는 이름이 나가지 않습니다.', 'submit.go': '검증 요청', 'submit.offline': '오프라인 — 제출 불가',
 'submit.noIdentity': '서명 키를 만들 수 없습니다 — http 로 접속하면 제출·공유가 꺼집니다 (https 또는 localhost 필요)',
 'chip.noKey': '서명 불가',
 'submit.offlineRate': '이 판을 시작할 때 서버가 요청이 많아 시드를 주지 않았습니다 — 잠시 후 RETRY 하면 제출할 수 있습니다',
 'submit.offlineNet': '이 판을 시작할 때 서버에 닿지 않았습니다 — 지금 연결이 좋아 보여도 이 판은 제출할 수 없습니다',
      ...
      'submit.copyFail': '자동 복사 실패', 'submit.copyHint': '링크를 길게 눌러 복사하세요',
      ...
      'pane.open': '월드 보드 · 명예의 전당', 'pane.mineBtn': '내 기록 ▸',
      'dev.hint': '기기는 브라우저가 스스로 보고한 분류입니다. 위조 가능하고 표시에만 쓰이며, 점수 판정에는 쓰지 않습니다.',
      'race.you': '나', 'race.them': '{who}', 'race.ahead': '+{gap}', 'race.behind': '-{gap}',
      'mine.title': '내 기록', 'mine.empty': '아직 기록이 없습니다.', 'mine.hint': '이 기기 · 서버',
      'mine.clear': '목록 지우기', 'mine.clearNote': '이 기기 목록에서만 지웁니다 — 서버 기록은 삭제하지 않는다',
      'mine.copy': '링크 복사', 'mine.noLink': '이 판은 서버에 제출되지 않아 링크가 없습니다',
      'mine.localOnly': '이 기기 기록 · 서버 미제출', 'mine.savedLocal': '오프라인 — 이 기기에만 기록으로 남겼습니다',
      'stats.players': '오늘 {n}명 · {m}개 네트워크',
      'lang.label': '언어',
      'err.network': '네트워크 오류',
      'net.bad': '서버에 닿지 않습니다 — 게임은 플레이되고 기록은 이 기기에만 남습니다',
      'net.noKey': '서버는 닿지만 이 브라우저는 서명 키를 만들 수 없습니다 — http 접속이 원인입니다 (https 또는 localhost 필요)',
      'net.noSeed': '이 판은 서버 시드를 받지 못했습니다 — 이번 판만 제출할 수 없습니다',
      'net.ok': '서버 연결됨 — 기록 제출 가능', 'err.rate': '요청이 너무 많습니다. 잠시 후 시도하세요.',
    ...
    en: {
      ...
      'submit.reveal': 'Show my name on the share link', 'submit.nameWarn': '⚠ Anyone who opens the link sees this name — including people it is re-shared with. Public boards never carry names.', 'submit.go': 'Verify & submit',
      'submit.offline': 'offline — cannot submit',
      'submit.noIdentity': 'This browser cannot create a signing key — over plain http, submit and share are off (needs https or localhost)',
      'chip.noKey': 'no signing key',
      'submit.offlineRate': 'The server issued no seed when this round started (too many requests) — press RETRY in a moment for a submittable round',
      'submit.offlineNet': 'The server was unreachable when this round started — even if the link looks fine now, this round cannot be submitted',
      ...
      'submit.copyFail': 'copy failed', 'submit.copyHint': 'long-press the link to copy',
      ...
      'pane.open': 'World board · Hall of Fame', 'pane.mineBtn': 'My records ▸',
      ...
      'mine.title': 'My records', 'mine.empty': 'No records yet.', 'mine.hint': 'this device · server',
      'mine.clear': 'clear list', 'mine.clearNote': 'clears only this device\'s list — server records are never deleted',
      'mine.copy': 'copy link', 'mine.noLink': 'this game was never submitted, so there is no link',
      ...
      'net.bad': 'Cannot reach the server — the game still plays; runs stay on this device',
      'net.noKey': 'Server reachable, but this browser cannot create a signing key — plain http is the cause (needs https or localhost)',
      'net.noSeed': 'This round got no server seed — only this round cannot be submitted',
      'net.ok': 'Server connected — submissions enabled', 'err.rate': 'too many requests, try later',
    ...
    ja: {
      ...
      'submit.reveal': '共有リンクに名前を表示', 'submit.nameWarn': '⚠ リンクを開いた人はこの名前を見ます。再共有した先にも見えます。公開ボードに名前は出ません。', 'submit.go': '検証して提出', 'submit.offline': 'オフライン — 提出不可',
 'submit.noIdentity': '署名キーを作れません — http で接続すると送信・共有は無効です（https または localhost が必要）',
 'chip.noKey': '署名不可',
 'submit.offlineRate': 'この回を開始したときサーバーが混雑していてシードをもらえませんでした — しばらくして RETRY すると送信できます',
 'submit.offlineNet': 'この回を開始したときサーバーに届きませんでした — 今つながっていてもこの回は送信できません',
      ...
      'submit.copyFail': '自動コピー失敗', 'submit.copyHint': 'リンクを長押ししてコピー',
      ...
      'pane.open': 'ワールドボード · 殿堂', 'pane.mineBtn': 'この端末の記録 ▸',
      'dev.hint': '機器分類はブラウザが自分で申告したものです。偽装可能で表示専用、採点には使いません。',
      'race.you': '自分', 'race.them': '{who}', 'race.ahead': '+{gap}', 'race.behind': '-{gap}',
      'mine.title': '自分の記録', 'mine.empty': '記録はまだありません。', 'mine.hint': 'この端末 · サーバー',
      'mine.clear': '一覧を消す', 'mine.clearNote': 'この端末の一覧から消えるだけ — サーバーの記録は消さない',
      'mine.copy': 'リンクをコピー', 'mine.noLink': 'この対局は送信されていないのでリンクがありません',
      'mine.localOnly': 'この端末のみ · 未提出', 'mine.savedLocal': 'オフライン — この端末にのみ保存しました',
      'stats.players': '本日 {n}人 · {m}ネットワーク',
      'lang.label': '言語',
      'err.network': 'ネットワークエラー',
      'net.bad': 'サーバーに届きません — ゲームは遊べ、記録はこの端末にだけ残ります',
      'net.noKey': 'サーバーはつながるがこのブラウザは署名キーを作れません — http が原因です（https または localhost が必要）',
      'net.noSeed': 'この回はサーバーシードをもらえませんでした — この回だけ送信できません',
      'net.ok': 'サーバー接続中 — 送信できます', 'err.rate': 'リクエストが多すぎます', 'err.banned': 'この回線はブロックされています',
    },
    zh: {
      ...
      'submit.reveal': '分享链接中显示我的名字', 'submit.nameWarn': '⚠ 打开链接的人会看到这个名字——被再次分享后也一样。公开榜不会带名字。', 'submit.go': '验证并提交', 'submit.offline': '离线 — 无法提交',
 'submit.noIdentity': '无法生成签名密钥 — 以 http 访问时提交与共享会关闭（需要 https 或 localhost）',
 'chip.noKey': '无法签名',
 'submit.offlineRate': '开始本局时服务器请求过多,未发放种子 — 稍后按 RETRY 即可提交',
 'submit.offlineNet': '开始本局时未能连接服务器 — 即使现在连接正常,本局也无法提交',
      ...
      'submit.copyFail': '自动复制失败', 'submit.copyHint': '长按链接即可复制',
      ...
      'pane.open': '世界榜 · 名人堂', 'pane.mineBtn': '我的记录 ▸',
      'dev.hint': '设备分类由浏览器自行上报（可伪造，仅作展示）——不用于判定成绩。',
      'race.you': '我', 'race.them': '{who}', 'race.ahead': '+{gap}', 'race.behind': '-{gap}',
      'mine.title': '我的记录', 'mine.empty': '还没有记录。', 'mine.hint': '本机 · 服务器',
      'mine.clear': '清空列表', 'mine.clearNote': '只从本机列表移除——不会删除服务器记录',
      'mine.copy': '复制链接', 'mine.noLink': '这局没有提交过，所以没有链接',
      'mine.localOnly': '仅本机 · 未提交', 'mine.savedLocal': '离线 — 仅保存在本机',
      'stats.players': '今日 {n} 人 · {m} 个网络',
      'lang.label': '语言',
      'err.network': '网络错误',
      'net.bad': '无法连接服务器 — 仍可游戏,记录只留在本机',
      'net.noKey': '能连上服务器,但此浏览器无法生成签名密钥 — 原因是 http 访问(需要 https 或 localhost)',
      'net.noSeed': '本局未获得服务器种子 — 仅本局无法提交',
      'net.ok': '已连接服务器 — 可提交', 'err.rate': '请求过多', 'err.banned': '该网络被封禁',
    },
  };
